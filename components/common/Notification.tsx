...
import { selectNotifications } from "@/lib/store/selectors";
import { removeNotification } from "@/lib/store/uiSlice";
...
function NotificationItem({
  ...
  const styles = {
    ...
    info: "bg-indigo-900/30 border-indigo-700/50 text-indigo-300",
  };
